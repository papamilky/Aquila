function _tide_item_cmd_duration
    test $CMD_DURATION -gt $tide_cmd_duration_threshold && t=(
        ...
        _tide_print_item cmd_duration $tide_cmd_duration_icon' ' "took $t[1]h $t[2]m $t[3]s"
    else if test $t[2] != 0
        _tide_print_item cmd_duration $tide_cmd_duration_icon' ' "took $t[2]m $t[3]s"
    else
        _tide_print_item cmd_duration $tide_cmd_duration_icon' ' "took $t[3]s"
    end
end
