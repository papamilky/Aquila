function _tide_print_item --argument-names item
    echo -en "\e[22m"  # Force normal weight at start, otherwise text is an ugly bold.
    ...
    echo -ens $_tide_pad "" $argv[2..] $_tide_pad ""
